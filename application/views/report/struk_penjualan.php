...
if ($id_resi == null) {
    $sql_general = "SELECT a.invoice, a.bayar, a.kembali, a.ppn, a.tgl, b.username, b.id_user, a.method FROM penjualan a, user b WHERE a.id_user = b.id_user AND a.id_jual = '$id'";
    ...
    $sql_general = "SELECT a.invoice, a.bayar, a.kembali, a.ppn, a.tgl, b.username, b.id_user, a.method FROM penjualan a, user b WHERE a.id_user = b.id_user AND a.id_jual = '$id_resi'";
    $sql_detail = "SELECT b.nama_barang, a.qty_jual, a.diskon, a.subtotal FROM detil_penjualan a,  barang b
