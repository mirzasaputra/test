...
$sqldetil = "SELECT a.id_barang, a.nama_barang, a.barcode, a.harga_pelanggan, a.harga_toko, a.harga_sales, b.satuan, c.kategori,  a.harga_beli,a.harga_jual, a.stok FROM barang a, satuan b, kategori c WHERE c.id_kategori = a.id_kategori AND b.id_satuan = a.id_satuan AND a.is_active = 1";
...
$pdf->Cell(25, 6, 'HARGA UMUM', 1, 0, 'C');
$pdf->Cell(35, 6, 'HARGA PELANGGAN', 1, 0, 'C');
$pdf->Cell(25, 6, 'HARGA TOKO', 1, 0, 'C');
$pdf->Cell(25, 6, 'HARGA SALES', 1, 0, 'C');
...
foreach ($detil as $d) {
    ...
    $pdf->Cell(25, 6, 'Rp. ' . number_format($d['harga_beli'], '0', '.', '.'), 1, 0);
    $pdf->Cell(25, 6, 'Rp. ' . number_format($d['harga_jual'], '0', '.', '.'), 1, 0);
    $pdf->Cell(35, 6, 'Rp. ' . number_format($d['harga_pelanggan'], '0', '.', '.'), 1, 0);
    $pdf->Cell(25, 6, 'Rp. ' . number_format($d['harga_toko'], '0', '.', '.'), 1, 0);
    $pdf->Cell(25, 6, 'Rp. ' . number_format($d['harga_sales'], '0', '.', '.'), 1, 0);
